...
const DoctorAvailibilites = ({ history,match }) => {
...
console.log('pushinginarray',pushinginarray)
    ...
    const { mutate, isLoading: editloading, status: promostatus } = useMutation((data) => timeslotDoctor(data), {
        retry: false,
        onSuccess: (res) => {
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="form-field">
                                    ...
                                    {/* <div class="row">
                            <div class="col-md-12">
                                <a href="index.php" class="btn_darkbluep">Add</a>                                  
                            </div>
                        </div>            
                                         */}
...
export default DoctorAvailibilites