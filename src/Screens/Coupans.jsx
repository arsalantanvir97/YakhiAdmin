...
import { getCoupans } from "./Api/Coupans";
const Coupans = ({ history }) => {
    ...
    const { isFetching, isLoading, data: coupans, status: prodstatus, refetch } = useQuery({
        queryKey: ["coupans", page, perPage, from, to, status, searchString, sort],
        queryFn: () => getCoupans(page, perPage, from, to, status, searchString, sort),
                                ...
                                <div className="py-5 px-5 mb-5">
                                    ...
                                    <div className="row">
                                        <ul className="nav nav-tabs tabTop" id="myTab" role="tablist">
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link active" id="coupons-tab" data-bs-toggle="tab" data-bs-target="#coupons" type="button" role="tab" aria-controls="coupons" aria-selected="true">Coupons</button>
                                            </li>
                                        </ul>
                                                    ...
                                                    <div className="col-12 col-md-12">
                                                        <div className>
                                                            <div className="p-3 mb-3">
                                                                <div className="row mb-2">
                                                                    <div className="col-12 d-flex align-content-center justify-content-between tckt-srch-row">
                                                                        ...
                                                                        <div className="d-flex">
                                                                            ...
                                                                            <Link to='/AddCoupan' className="btn_darkbluep mt-0 d-inline-block px-5 me-2">Add Coupan</Link>
                                                                                    ...
                                                                                    <div className="row">
                                                                                        <div className="col-sm-12">
                                                                                            <table className="table table-borderless dataTable">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    {coupans?.docs?.length > 0 &&
                                                                                                        coupans?.docs?.map((taxx, index) => (

                                                                                                            <tr>
                                                                                                                <td>{index + 1}</td>
                                                                                                                <td>{taxx?.title}</td>
                                                                                                                <td>
                                                                                                                    {moment(taxx?.startingdate).format(
                                                                                                                        "LL"
                                                                                                                    )}
                                                                                                                    </td>   
                                                                                                                <td>
                                                                                                                    {moment(taxx?.endingdate).format(
                                                                                                                        "LL"
                                                                                                                    )}</td>
                                                                                                                <td>
                                                                                                                    {taxx?.coupan
                                                                ...
                                                                {coupans?.docs?.length > 0 && (
                                                                    <Pagination
                                                                        totalDocs={coupans?.totalDocs}
                                                                        totalPages={coupans?.totalPages}
                                                                        currentPage={coupans?.page}
                                                                        setPage={setPage}
                                                                        hasNextPage={coupans?.hasNextPage}
                                                                        hasPrevPage={coupans?.hasPrevPage}
                                                                    />
                                                                )}
                                                            </div>
                                                        </div>
